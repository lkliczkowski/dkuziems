...
namespace PrimalPerceptronAlgorithm
{
    public static class ReadData
    {
        ...
        public static void ReadDoubleList(string FILE, ref List<double[]> data)
        {
            ...
            {
                data.Add(ParseLineToDouble(record));
            }
        }

        private static double[] ParseLineToDouble(string[] toParse)
        {
